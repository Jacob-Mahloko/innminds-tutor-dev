...
using InnmindsApi.Web.Startup;
using AngleSharp.Html.Dom;
using AngleSharp.Html.Parser;
using Microsoft.AspNetCore.Hosting;
using Shouldly;

namespace InnmindsApi.Web.Tests
{
    public abstract class InnmindsApiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InnmindsApiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InnmindsApiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<InnmindsApiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<InnmindsApiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InnmindsApiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InnmindsApiDbContext, Task<T>> func)
        {
            T result;
