...
{
    public abstract class innminds-apiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static innminds-apiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(innminds-apiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<innminds-apiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<innminds-apiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<innminds-apiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<innminds-apiDbContext, Task<T>> func)
        {
            T result;
